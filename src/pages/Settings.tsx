import { Bell, User, Mail, Shield, BellRing, Moon, ChevronRight, Save, Terminal, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-12">
        <div className="flex items-center gap-4">
          {onBack && (
            <button 
              onClick={onBack}
              className="p-3 bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl text-[var(--text-muted)] hover:text-white hover:border-orange-500/30 transition-all shadow-md shrink-0"
